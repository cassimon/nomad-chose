...
Nomad ELN for UNITOV using baseclasses from Hysprint
...
```sh
git clone https://github.com/Tor Vergata University of Rome/nomad_chose.git
cd nomad_chose
...
| Name | E-mail     |
|------|------------|
| Simon Ternes | [ternes@ing.uniroma2.it](mailto:ternes@ing.uniroma2.it)
